        ...
        app.ticker.add(() => {
            ...
            playerList.forEach((otherPlayer) => {
                ...
                const distX = Math.abs(
                    otherPlayer.worldPos.x - player.worldPos.x
                );
                const distY = Math.abs(
                    otherPlayer.worldPos.y - player.worldPos.y
                );
                ...
                if (
                    ...
                    otherPlayer.sprite.x =
                        player.sprite.x +
                        otherPlayer.worldPos.x -
                        player.worldPos.x;
                    otherPlayer.sprite.y =
                        player.sprite.y +
                        otherPlayer.worldPos.y -
                        player.worldPos.y;
            ...
            bulletList.forEach((missile) => {
                ...
                if (
                    distX < window.innerWidth / 2 &&
                    distY < window.innerHeight / 2
                ) {
                    missile.sprite.x =
                        missile.worldPos.x +
                        window.innerWidth / 2 -
